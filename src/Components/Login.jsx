...
import { setAdmin, setIsLoggedIn } from "../reducers/adminSlice";
  ...
  const handleLogin = async () => {
    try {
      const response = await axios
        .post(
          `${urls.login}?mobile_number=${userDetail.mobile}&password=${userDetail.password}&is_admin=${userDetail.isAdmin}`
        )
        .then((res) => res.data)
